...
class ChannelsControllerTest < ActionController::TestCase
  ...
  test "should create channel" do
    assert_difference('Channel.count') do
      post :create, channel: { description: @channel.description, name: @channel.name, publish_flag: @channel.publish_flag }
    end
  ...
  test "should update channel" do
    put :update, id: @channel, channel: { description: @channel.description, name: @channel.name, publish_flag: @channel.publish_flag }
    assert_redirected_to channel_path(assigns(:channel))
  end
